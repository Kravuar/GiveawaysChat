...
import net.kravuar.fluxsocket.application.props.DestinationsProps;
import net.kravuar.fluxsocket.application.repo.GiveawayRepository;
import net.kravuar.fluxsocket.domain.dto.NewGiveawayDTO;
import net.kravuar.fluxsocket.domain.exceptions.GiveawayExhaustedException;
import net.kravuar.fluxsocket.domain.exceptions.GiveawayIsPrivateException;
import net.kravuar.fluxsocket.domain.exceptions.ResourceNotFoundException;
